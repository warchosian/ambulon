...
"""Module pour récupérer les informations d'un document RAG PIAG."""
...
def get_document(
    ...
    """
    Récupère les informations d'un document RAG PIAG.
    ...
    Returns:
        La réponse JSON de l'API contenant les informations du document.
    ...
    try:
        ...
        print(f"Erreur lors de la récupération du document: {e}", file=sys.stderr)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Récupère les informations d'un document RAG PIAG.",
