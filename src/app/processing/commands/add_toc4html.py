...
def add_toc_to_html(
    ...
    if output_path is None:
        output_file = input_file.parent / f"{input_file.stem}-tocced{input_file.suffix}"
    else:
...
def register_add_toc4html_command(subparsers):
    """
    Register the add-toc4html command with the argument parser.
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Output HTML file path (default: <input>-tocced.html)'
    )
