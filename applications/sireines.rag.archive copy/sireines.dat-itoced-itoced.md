...
# Dossier d'Architecture Technique (DAT) - SIREINES [↑](#table-of-contents) [↑](#toc-dossier-darchitecture-technique-dat---sireines-table-of-contents)
...
## 1. Introduction et objectifs [↑](#table-of-contents) [↑](#toc-introduction) {#introduction}

### 1.1 Vue d'ensemble fonctionnelle [↑](#table-of-contents) [↑](#toc-11-vue-densemble-fonctionnelle-table-of-contents)
...
### 1.2 Architecture C4 - Niveau 1 (Système) [↑](#table-of-contents) [↑](#toc-12-architecture-c4---niveau-1-système-table-of-contents)
...
### 1.3 Objectifs de qualité orientés utilisateur [↑](#table-of-contents) [↑](#toc-13-objectifs-de-qualité-orientés-utilisateur-table-of-contents)
...
## 2. Parties prenantes [↑](#table-of-contents) [↑](#toc-parties-prenantes) {#parties-prenantes}
...
## 3. Contraintes [↑](#table-of-contents) [↑](#toc-contraintes) {#contraintes}

### 3.1 Contraintes techniques [↑](#table-of-contents) [↑](#toc-31-contraintes-techniques-table-of-contents)
...
### 3.2 Contraintes organisationnelles [↑](#table-of-contents) [↑](#toc-32-contraintes-organisationnelles-table-of-contents)
...
### 3.3 Exigences de sécurité (Modèle D-I-C-T) [↑](#table-of-contents) [↑](#toc-33-exigences-de-sécurité-modèle-d-i-c-t-table-of-contents)
...
### 3.4 Contraintes réglementaires [↑](#table-of-contents) [↑](#toc-34-contraintes-réglementaires-table-of-contents)
...
## 4. Contexte et périmètre [↑](#table-of-contents) [↑](#toc-contexte) {#contexte}

### 4.1 Partenaires fonctionnels [↑](#table-of-contents) [↑](#toc-41-partenaires-fonctionnels-table-of-contents)
...
### 4.2 Interfaces techniques [↑](#table-of-contents) [↑](#toc-42-interfaces-techniques-table-of-contents)
...
## 5. Stratégie de solution [↑](#table-of-contents) [↑](#toc-strategie) {#strategie}

### 5.1 Décisions architecturales majeures [↑](#table-of-contents) [↑](#toc-51-décisions-architecturales-majeures-table-of-contents)
...
### 5.2 Environnement technologique [↑](#table-of-contents) [↑](#toc-52-environnement-technologique-table-of-contents)
...
### 5.3 Forge logicielle [↑](#table-of-contents) [↑](#toc-53-forge-logicielle-table-of-contents)
...
## 6. Vue en Briques (C4-L2) [↑](#table-of-contents) [↑](#toc-briques) {#briques}

### 6.1 Vue Conteneur [↑](#table-of-contents) [↑](#toc-61-vue-conteneur-table-of-contents)
...
### 6.2 Description des conteneurs [↑](#table-of-contents) [↑](#toc-62-description-des-conteneurs-table-of-contents)
...
### 6.3 Structure des modules [↑](#table-of-contents) [↑](#toc-63-structure-des-modules-table-of-contents)
...
## 7. Vue Exécution [↑](#table-of-contents) [↑](#toc-execution) {#execution}

### 7.1 Scénario : Création d'un dossier d'évaluation [↑](#table-of-contents) [↑](#toc-71-scénario-création-dun-dossier-dévaluation-table-of-contents)
...
### 7.2 Scénario : Génération d'un rapport statistique [↑](#table-of-contents) [↑](#toc-72-scénario-génération-dun-rapport-statistique-table-of-contents)
...
### 7.3 Scénario : Import de données agents (batch) [↑](#table-of-contents) [↑](#toc-73-scénario-import-de-données-agents-batch-table-of-contents)
...
## 8. Vue Déploiement [↑](#table-of-contents) [↑](#toc-deploiement) {#deploiement}

### 8.1 Environnements [↑](#table-of-contents) [↑](#toc-81-environnements-table-of-contents)
...
### 8.2 Infrastructure [↑](#table-of-contents) [↑](#toc-82-infrastructure-table-of-contents)
...
### 8.3 Supervision [↑](#table-of-contents) [↑](#toc-83-supervision-table-of-contents)
...
### 8.4 Sauvegardes [↑](#table-of-contents) [↑](#toc-84-sauvegardes-table-of-contents)
...
## 9. Sujets transverses [↑](#table-of-contents) [↑](#toc-transverses) {#transverses}

### 9.1 Authentification et autorisation [↑](#table-of-contents) [↑](#toc-91-authentification-et-autorisation-table-of-contents)
...
### 9.2 Journalisation et traçabilité [↑](#table-of-contents) [↑](#toc-92-journalisation-et-traçabilité-table-of-contents)
...
### 9.3 Gestion des erreurs [↑](#table-of-contents) [↑](#toc-93-gestion-des-erreurs-table-of-contents)
...
### 9.4 API et intégrations [↑](#table-of-contents) [↑](#toc-94-api-et-intégrations-table-of-contents)
...
## 10. Exigences de qualité [↑](#table-of-contents) [↑](#toc-qualite) {#qualite}
...
## 11. Risques et dettes techniques [↑](#table-of-contents) [↑](#toc-risques) {#risques}
...
## 12. Annexes [↑](#table-of-contents) [↑](#toc-annexes) {#annexes}

### 12.1 Glossaire [↑](#table-of-contents) [↑](#toc-121-glossaire-table-of-contents)
...
### 12.2 Décisions d'Architecture (ADR) [↑](#table-of-contents) [↑](#toc-122-décisions-darchitecture-adr-table-of-contents)

#### ADR-001 : Maintien de Java 7 pour compatibilité legacy [↑](#table-of-contents) [↑](#toc-adr-001-maintien-de-java-7-pour-compatibilité-legacy-table-of-contents)
...
#### ADR-002 : Elasticsearch embarqué vs cluster dédié [↑](#table-of-contents) [↑](#toc-adr-002-elasticsearch-embarqué-vs-cluster-dédié-table-of-contents)
...
#### ADR-003 : Conservation de BIRT pour les rapports [↑](#table-of-contents) [↑](#toc-adr-003-conservation-de-birt-pour-les-rapports-table-of-contents)
...
#### ADR-004 : Architecture monolithique conteneurisée [↑](#table-of-contents) [↑](#toc-adr-004-architecture-monolithique-conteneurisée-table-of-contents)
