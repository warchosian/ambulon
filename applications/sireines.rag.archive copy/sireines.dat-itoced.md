...
## 1. Introduction et objectifs [↑](#toc-introduction) {#introduction}

<a id="11-vue-densemble-fonctionnelle"></a>
### 1.1 Vue d'ensemble fonctionnelle [↑](#toc-11-vue-densemble-fonctionnelle)
...
### 1.2 Architecture C4 - Niveau 1 (Système) [↑](#toc-12-architecture-c4---niveau-1-système)
...
### 1.3 Objectifs de qualité orientés utilisateur [↑](#toc-13-objectifs-de-qualité-orientés-utilisateur)
...
## 2. Parties prenantes [↑](#toc-parties-prenantes) {#parties-prenantes}
...
## 3. Contraintes [↑](#toc-contraintes) {#contraintes}

<a id="31-contraintes-techniques"></a>
### 3.1 Contraintes techniques [↑](#toc-31-contraintes-techniques)
...
### 3.2 Contraintes organisationnelles [↑](#toc-32-contraintes-organisationnelles)
...
### 3.3 Exigences de sécurité (Modèle D-I-C-T) [↑](#toc-33-exigences-de-sécurité-modèle-d-i-c-t)
...
### 3.4 Contraintes réglementaires [↑](#toc-34-contraintes-réglementaires)
...
## 4. Contexte et périmètre [↑](#toc-contexte) {#contexte}

<a id="41-partenaires-fonctionnels"></a>
### 4.1 Partenaires fonctionnels [↑](#toc-41-partenaires-fonctionnels)
...
### 4.2 Interfaces techniques [↑](#toc-42-interfaces-techniques)
...
## 5. Stratégie de solution [↑](#toc-strategie) {#strategie}

<a id="51-décisions-architecturales-majeures"></a>
### 5.1 Décisions architecturales majeures [↑](#toc-51-décisions-architecturales-majeures)
...
### 5.2 Environnement technologique [↑](#toc-52-environnement-technologique)
...
### 5.3 Forge logicielle [↑](#toc-53-forge-logicielle)
...
## 6. Vue en Briques (C4-L2) [↑](#toc-briques) {#briques}

<a id="61-vue-conteneur"></a>
### 6.1 Vue Conteneur [↑](#toc-61-vue-conteneur)
...
### 6.2 Description des conteneurs [↑](#toc-62-description-des-conteneurs)
...
### 6.3 Structure des modules [↑](#toc-63-structure-des-modules)
...
## 7. Vue Exécution [↑](#toc-execution) {#execution}

<a id="71-scénario-création-dun-dossier-dévaluation"></a>
### 7.1 Scénario : Création d'un dossier d'évaluation [↑](#toc-71-scénario-création-dun-dossier-dévaluation)
...
### 7.2 Scénario : Génération d'un rapport statistique [↑](#toc-72-scénario-génération-dun-rapport-statistique)
...
### 7.3 Scénario : Import de données agents (batch) [↑](#toc-73-scénario-import-de-données-agents-batch)
...
## 8. Vue Déploiement [↑](#toc-deploiement) {#deploiement}

<a id="81-environnements"></a>
### 8.1 Environnements [↑](#toc-81-environnements)
...
### 8.2 Infrastructure [↑](#toc-82-infrastructure)
...
### 8.3 Supervision [↑](#toc-83-supervision)
...
### 8.4 Sauvegardes [↑](#toc-84-sauvegardes)
...
## 9. Sujets transverses [↑](#toc-transverses) {#transverses}

<a id="91-authentification-et-autorisation"></a>
### 9.1 Authentification et autorisation [↑](#toc-91-authentification-et-autorisation)
...
### 9.2 Journalisation et traçabilité [↑](#toc-92-journalisation-et-traçabilité)
...
### 9.3 Gestion des erreurs [↑](#toc-93-gestion-des-erreurs)
...
### 9.4 API et intégrations [↑](#toc-94-api-et-intégrations)
...
## 10. Exigences de qualité [↑](#toc-qualite) {#qualite}
...
## 11. Risques et dettes techniques [↑](#toc-risques) {#risques}
...
## 12. Annexes [↑](#toc-annexes) {#annexes}

<a id="121-glossaire"></a>
### 12.1 Glossaire [↑](#toc-121-glossaire)
...
### 12.2 Décisions d'Architecture (ADR) [↑](#toc-122-décisions-darchitecture-adr)

<a id="adr-001-maintien-de-java-7-pour-compatibilité-legacy"></a>
#### ADR-001 : Maintien de Java 7 pour compatibilité legacy [↑](#toc-adr-001-maintien-de-java-7-pour-compatibilité-legacy)
...
#### ADR-002 : Elasticsearch embarqué vs cluster dédié [↑](#toc-adr-002-elasticsearch-embarqué-vs-cluster-dédié)
...
#### ADR-003 : Conservation de BIRT pour les rapports [↑](#toc-adr-003-conservation-de-birt-pour-les-rapports)
...
#### ADR-004 : Architecture monolithique conteneurisée [↑](#toc-adr-004-architecture-monolithique-conteneurisée)
