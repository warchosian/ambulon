...
# DAT Vue Composants & Analyse de Sécurité - SIREINES [↑](#toc-dat-vue-composants-analyse-de-securite-sireines)
...
- <a id="toc-dat-vue-composants-analyse-de-securite-sireines"></a>[DAT Vue Composants & Analyse de Sécurité - SIREINES](#dat-vue-composants-analyse-de-securite-sireines)
- <a id="toc-vue-composants"></a>[1. Vue Composants (C4-L3) - Architecture Interne Détaillée](#vue-composants)
  - <a id="toc-1-1-diagramme-de-composants-global"></a>[1.1 Diagramme de composants global](#1-1-diagramme-de-composants-global)
  - <a id="toc-1-2-fiches-composants-detaillees"></a>[1.2 Fiches composants détaillées](#1-2-fiches-composants-detaillees)
    - <a id="toc-comp-001-dossierrecherchemotsclefsaction"></a>[COMP-001 : DossierRechercheMotsClefsAction](#comp-001-dossierrecherchemotsclefsaction)
      - <a id="toc-interfaces-exposees"></a>[Interfaces exposées](#interfaces-exposees)
      - <a id="toc-dependances-internes"></a>[Dépendances internes](#dependances-internes)
      - <a id="toc-dependances-externes"></a>[Dépendances externes](#dependances-externes)
      - <a id="toc-vulnerabilites-critiques-identifiees"></a>[🔴 Vulnérabilités critiques identifiées](#vulnerabilites-critiques-identifiees)
      - <a id="toc-dette-technique"></a>[Dette technique](#dette-technique)
    - <a id="toc-comp-002-extractionsservicesimpl"></a>[COMP-002 : ExtractionsServicesImpl](#comp-002-extractionsservicesimpl)
      - <a id="toc-vulnerabilites-critiques-identifiees-1"></a>[🔴 Vulnérabilités critiques identifiées](#vulnerabilites-critiques-identifiees-1)
      - <a id="toc-dette-technique-critique"></a>[Dette technique - 🔴 Critique](#dette-technique-critique)
    - <a id="toc-comp-003-importsservicesimpl"></a>[COMP-003 : ImportsServicesImpl](#comp-003-importsservicesimpl)
      - <a id="toc-vulnerabilites-critiques-identifiees-2"></a>[🔴 Vulnérabilités critiques identifiées](#vulnerabilites-critiques-identifiees-2)
    - <a id="toc-comp-004-cerbereutil-sireinessessionfilter"></a>[COMP-004 : CerbereUtil + SireinesSessionFilter](#comp-004-cerbereutil-sireinessessionfilter)
      - <a id="toc-dependances-externes-critiques"></a>[Dépendances externes critiques](#dependances-externes-critiques)
      - <a id="toc-vulnerabilites-identifiees"></a>[🟡 Vulnérabilités identifiées](#vulnerabilites-identifiees)
    - <a id="toc-comp-005-esembedeadsearchservicesplugin"></a>[COMP-005 : ESEmbeddedSearchServicesPlugin](#comp-005-esembedeadsearchservicesplugin)
      - <a id="toc-vulnerabilites-critiques"></a>[🔴 Vulnérabilités critiques](#vulnerabilites-critiques)
- <a id="toc-stride"></a>[2. Matrice de vulnérabilités STRIDE](#stride)
- <a id="toc-dependances"></a>[3. Inventaire des dépendances et vulnérabilités](#dependances)
  - <a id="toc-3-1-dependances-maven-pom-xml-sireines-web"></a>[3.1 Dépendances Maven (pom.xml sireines-web)](#3-1-dependances-maven-pom-xml-sireines-web)
  - <a id="toc-3-2-dependances-frontend-analyse-templates"></a>[3.2 Dépendances Frontend (analyse templates)](#3-2-dependances-frontend-analyse-templates)
- <a id="toc-dette-technique-1"></a>[4. Dettes techniques identifiées](#dette-technique-1)
- <a id="toc-recommandations"></a>[5. Recommandations de sécurité prioritaires](#recommandations)
  - <a id="toc-5-1-court-terme-0-3-mois-urgent"></a>[5.1 Court terme (0-3 mois) - 🔴 Urgent](#5-1-court-terme-0-3-mois-urgent)
  - <a id="toc-5-2-moyen-terme-3-12-mois-important"></a>[5.2 Moyen terme (3-12 mois) - 🟡 Important](#5-2-moyen-terme-3-12-mois-important)
  - <a id="toc-5-3-long-terme-12-mois-strategique"></a>[5.3 Long terme (> 12 mois) - 🟢 Stratégique](#5-3-long-terme-12-mois-strategique)
- <a id="toc-dfd"></a>[6. Schéma de flux de données sécurisé (DFD)](#dfd)
- <a id="toc-owasp"></a>[7. Checklist OWASP Top 10 2021 - Mapping complet](#owasp)
- <a id="toc-plan-action"></a>[8. Plan d'action sécurité synthétique](#plan-action)
- <a id="toc-annexes"></a>[9. Annexes](#annexes)
  - <a id="toc-9-1-glossaire-securite"></a>[9.1 Glossaire sécurité](#9-1-glossaire-securite)
  - <a id="toc-9-2-references-cve-critiques-a-surveiller"></a>[9.2 Références CVE critiques à surveiller](#9-2-references-cve-critiques-a-surveiller)

---

## 1. Vue Composants (C4-L3) - Architecture Interne Détaillée [↑](#toc-vue-composants) {#vue-composants}

### 1.1 Diagramme de composants global [↑](#toc-1-1-diagramme-de-composants-global)
...
### 1.2 Fiches composants détaillées [↑](#toc-1-2-fiches-composants-detaillees)
...
##### Interfaces exposées [↑](#toc-interfaces-exposees)
...
##### Dépendances internes [↑](#toc-dependances-internes)
...
##### Dépendances externes [↑](#toc-dependances-externes)
...
##### 🔴 Vulnérabilités critiques identifiées [↑](#toc-vulnerabilites-critiques-identifiees)
...
##### 🔴 Vulnérabilités critiques identifiées [↑](#toc-vulnerabilites-critiques-identifiees-1)
...
##### 🔴 Vulnérabilités critiques identifiées [↑](#toc-vulnerabilites-critiques-identifiees-2)
...
##### Dépendances externes critiques [↑](#toc-dependances-externes-critiques)
...
##### 🟡 Vulnérabilités identifiées [↑](#toc-vulnerabilites-identifiees)
...
#### COMP-005 : ESEmbeddedSearchServicesPlugin [↑](#toc-comp-005-esembedeadsearchservicesplugin)
...
##### 🔴 Vulnérabilités critiques [↑](#toc-vulnerabilites-critiques)
...
### 3.1 Dépendances Maven (pom.xml sireines-web) [↑](#toc-3-1-dependances-maven-pom-xml-sireines-web)
...
### 3.2 Dépendances Frontend (analyse templates) [↑](#toc-3-2-dependances-frontend-analyse-templates)
...
## 4. Dettes techniques identifiées [↑](#toc-dette-technique-1) {#dette-technique}
...
### 5.1 Court terme (0-3 mois) - 🔴 Urgent [↑](#toc-5-1-court-terme-0-3-mois-urgent)
...
### 5.2 Moyen terme (3-12 mois) - 🟡 Important [↑](#toc-5-2-moyen-terme-3-12-mois-important)
...
### 5.3 Long terme (> 12 mois) - 🟢 Stratégique [↑](#toc-5-3-long-terme-12-mois-strategique)
...
### 9.1 Glossaire sécurité [↑](#toc-9-1-glossaire-securite)
...
### 9.2 Références CVE critiques à surveiller [↑](#toc-9-2-references-cve-critiques-a-surveiller)
