...
| `_prompt_c4model.md` | **DAT** — Dossier d'Architecture Technique (C4) | C4 Model, Mermaid C4 | Communication visuelle architecture | Architectes, développeurs, stakeholders |
...
- `REGLES_MERMAID.md` : Règles de syntaxe Mermaid
...
> 💡 **Bon à savoir** : Ces prompts sont conçus pour être utilisés avec des assistants IA (Claude, GPT, etc.) et générer des documents Markdown prêts à l'emploi dans VS Code ou Obsidian avec support Mermaid.
