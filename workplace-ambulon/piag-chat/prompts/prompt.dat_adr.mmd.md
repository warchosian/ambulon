...
2. **Niveau 1 — Vue Contexte (C4 System Context)**
   - **Diagramme C4-L1** en Mermaid : positionnement du système.
...
3. **Niveau 2 — Vue Conteneurs (C4 Containers)**
   - **Diagramme C4-L2** en Mermaid : décomposition en applications.
...
5. **Niveau 3 — Vue Composants (C4 Components)** *(pour les conteneurs critiques)*
   - **Diagrammes C4-L3** en Mermaid pour 1 à 3 conteneurs principaux.
...
- Tous les diagrammes C4 doivent utiliser la **syntaxe C4-Mermaid** :
  ```Mermaid
