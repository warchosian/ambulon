...
Ce document doit être autoporté, prêt à être rendu dans VS Code ou Obsidian (avec support Mermaid activé), sans dépendances externes, et sans aucune hypothèse ni donnée externe.
...
Illustré avec de nombreux diagrammes Mermaid pertinents :
Cas d’usage,
Séquence,
Composants,
Déploiement,
...
5. Format de sortie
Un seul fichier .md,
Syntaxe Mermaid valide (@startuml / @enduml),
Compatible avec les extensions VS Code / Obsidian (ex. Markdown Preview Enhanced, Mermaid).