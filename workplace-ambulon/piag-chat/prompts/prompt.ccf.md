...
4. **Cas d'usage (Use Cases)**
   - **Diagramme de Cas d'Utilisation UML** (ISO/IEC 19505) en PlantUML.
...
5. **Processus métier** (optionnel selon complexité)
   - **Diagramme BPMN** (ISO/IEC 19510) en PlantUML ou description textuelle.
...
- Utilise des **diagrammes PlantUML** pour les cas d'usage et processus.
