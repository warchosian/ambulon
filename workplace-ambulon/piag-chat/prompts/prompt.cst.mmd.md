...
2. **Architecture logicielle**
   - **Diagramme de Composants UML** (ISO/IEC 19505) en Mermaid.
...
4. **Modélisation statique**
   - **Diagramme de Classes UML** (ISO/IEC 19505-2) en Mermaid.
...
7. **Architecture de déploiement**
   - **Diagramme de Déploiement UML** (ISO/IEC 19505) en Mermaid.
...
- Tous les diagrammes UML doivent utiliser la syntaxe **Mermaid** valide.
