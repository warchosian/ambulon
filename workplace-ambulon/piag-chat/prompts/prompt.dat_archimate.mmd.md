...
graph TB
    ...
    %% Styles ArchiMate
    classDef businessService fill:#FFFF99,stroke:#333,stroke-width:2px
    classDef businessProcess fill:#FFFF66,stroke:#333,stroke-width:2px

    class SC businessService
    class TC businessProcess
```
...
- Fichier Markdown avec diagrammes Mermaid ArchiMate
