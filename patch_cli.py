...
if old_text in content:
    ...
    # Essayons avec un seul backslash
    old_text2 = '''    print("  ambulon mcp                         Démarrer le serveur MCP")
    print("  ambulon gitlab-clone                Cloner les projets configurés")
    print("  ambulon gitlab-monofile G:\\repos\\my-project")
    print()
    print("Pour plus d'informations sur un module spécifique:")
    ...
    if old_text2 in content:
        ...
        with open('src/app/cli/cli.py', 'w', encoding='utf-8') as f:
            f.write(content)
        print("Patch appliqué avec succès (version 2)!")
    else:
        print("Texte à remplacer non trouvé (version 2)")
