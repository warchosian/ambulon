...
<ul>
<li><a id="toc-c4-l1"></a><a href="#c4-l1">Niveau 1 : Vue Contexte (C4-L1)</a>
<ul>
<li><a id="toc-11-diagramme-système"></a><a href="#11-diagramme-système">1.1 Diagramme Système</a>
</li>
<li><a id="toc-12-description-des-acteurs"></a><a href="#12-description-des-acteurs">1.2 Description des Acteurs</a>
</li>
<li><a id="toc-13-systèmes-externes"></a><a href="#13-systèmes-externes">1.3 Systèmes Externes</a>
</ul>
</li>
<li><a id="toc-c4-l2"></a><a href="#c4-l2">Niveau 2 : Vue Conteneurs (C4-L2)</a>
<ul>
<li><a id="toc-21-diagramme-conteneurs"></a><a href="#21-diagramme-conteneurs">2.1 Diagramme Conteneurs</a>
</li>
<li><a id="toc-22-description-des-conteneurs"></a><a href="#22-description-des-conteneurs">2.2 Description des Conteneurs</a>
</li>
<li><a id="toc-23-flux-de-données-entre-conteneurs"></a><a href="#23-flux-de-données-entre-conteneurs">2.3 Flux de données entre conteneurs</a>
</ul>
</li>
<li><a id="toc-c4-l3"></a><a href="#c4-l3">Niveau 3 : Vue Composants (C4-L3)</a>
<ul>
<li><a id="toc-31-diagramme-composants-couche-présentation"></a><a href="#31-diagramme-composants-couche-présentation">3.1 Diagramme Composants - Couche Présentation</a>
</li>
<li><a id="toc-32-diagramme-composants-couche-service"></a><a href="#32-diagramme-composants-couche-service">3.2 Diagramme Composants - Couche Service</a>
</li>
<li><a id="toc-33-diagramme-composants-couche-accès-données"></a><a href="#33-diagramme-composants-couche-accès-données">3.3 Diagramme Composants - Couche Accès Données</a>
</li>
<li><a id="toc-34-tableau-récapitulatif-des-composants"></a><a href="#34-tableau-récapitulatif-des-composants">3.4 Tableau récapitulatif des composants</a>
</ul>
</li>
<li><a id="toc-c4-l4"></a><a href="#c4-l4">Niveau 4 : Vue Code (C4-L4)</a>
<ul>
<li><a id="toc-41-structure-du-codebase"></a><a href="#41-structure-du-codebase">4.1 Structure du codebase</a>
</li>
<li><a id="toc-42-exemple-de-code-pattern-mda-vertigo"></a><a href="#42-exemple-de-code-pattern-mda-vertigo">4.2 Exemple de code - Pattern MDA Vertigo</a>
</li>
<li><a id="toc-43-exemple-de-modèle-ksp-keyword-scripting"></a><a href="#43-exemple-de-modèle-ksp-keyword-scripting">4.3 Exemple de modèle KSP (Keyword Scripting)</a>
</ul>
</li>
<li><a id="toc-dependances"></a><a href="#dependances">Cartographie des dépendances</a>
</li>
<li><a id="toc-traceabilite"></a><a href="#traceabilite">Matrice de traçabilité C4</a>
</li>
<li><a id="toc-synthese"></a><a href="#synthese">Synthèse architecture C4</a>
</li>
</ul>
...
## Niveau 1 : Vue Contexte (C4-L1) [↑](#toc-c4-l1) {#c4-l1}

<a id="11-diagramme-système"></a>
### 1.1 Diagramme Système [↑](#toc-11-diagramme-système)
...
<a id="12-description-des-acteurs"></a>
### 1.2 Description des Acteurs [↑](#toc-12-description-des-acteurs)
...
<a id="13-systèmes-externes"></a>
### 1.3 Systèmes Externes [↑](#toc-13-systèmes-externes)
...
## Niveau 2 : Vue Conteneurs (C4-L2) [↑](#toc-c4-l2) {#c4-l2}

<a id="21-diagramme-conteneurs"></a>
### 2.1 Diagramme Conteneurs [↑](#toc-21-diagramme-conteneurs)
...
<a id="22-description-des-conteneurs"></a>
### 2.2 Description des Conteneurs [↑](#toc-22-description-des-conteneurs)
...
<a id="23-flux-de-données-entre-conteneurs"></a>
### 2.3 Flux de données entre conteneurs [↑](#toc-23-flux-de-données-entre-conteneurs)
...
## Niveau 3 : Vue Composants (C4-L3) [↑](#toc-c4-l3) {#c4-l3}

### 3.1 Diagramme Composants - Couche Présentation [↑](#toc-31-diagramme-composants---couche-présentation)
...
### 3.2 Diagramme Composants - Couche Service [↑](#toc-32-diagramme-composants---couche-service)
...
### 3.3 Diagramme Composants - Couche Accès Données [↑](#toc-33-diagramme-composants---couche-accès-données)
...
<a id="34-tableau-récapitulatif-des-composants"></a>
### 3.4 Tableau récapitulatif des composants [↑](#toc-34-tableau-récapitulatif-des-composants)
...
## Niveau 4 : Vue Code (C4-L4) [↑](#toc-c4-l4) {#c4-l4}

<a id="41-structure-du-codebase"></a>
### 4.1 Structure du codebase [↑](#toc-41-structure-du-codebase)
...
### 4.2 Exemple de code - Pattern MDA Vertigo [↑](#toc-42-exemple-de-code---pattern-mda-vertigo)
...
<a id="43-exemple-de-modèle-ksp-keyword-scripting"></a>
### 4.3 Exemple de modèle KSP (Keyword Scripting) [↑](#toc-43-exemple-de-modèle-ksp-keyword-scripting)
...
## Cartographie des dépendances [↑](#toc-dependances) {#dependances}
...
## Matrice de traçabilité C4 [↑](#toc-traceabilite) {#traceabilite}
...
## Synthèse architecture C4 [↑](#toc-synthese) {#synthese}
