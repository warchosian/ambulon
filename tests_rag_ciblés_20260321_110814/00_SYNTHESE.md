...
- **Différence de longueur (avec RAG - sans RAG)**: -5147 caractères
- **Amélioration des détails techniques**: 50.0% des cas
...
⚠️ **Le RAG fonctionne partiellement** : 50% des réponses bénéficient du contexte, mais certaines questions pourraient être améliorées.
...
|---|---|---|---|---|---|---|---|
| Q1 | Composants Java | 5 | 3 | 4/3 | 0% | ⚠️ | [Voir](./q1_rapport.md) |
| Q2 | Vulnérabilités CVE | 7 | 5 | 3/4 | 0% | ✅ | [Voir](./q2_rapport.md) |
| Q3 | Configuration technique | 5 | 4 | 4/4 | 0% | ⚠️ | [Voir](./q3_rapport.md) |
| Q4 | Décisions architecturales | 5 | 5 | 5/7 | 0% | ✅ | [Voir](./q4_rapport.md) |
| Q5 | Sécurité STRIDE | 7 | 4 | 3/2 | 0% | ⚠️ | [Voir](./q5_rapport.md) |
| Q6 | ISO 25010 | 7 | 5 | 2/5 | 0% | ✅ | [Voir](./q6_rapport.md) |
| Q7 | Modèle C4 Level 3 | 5 | 2 | 3/2 | 0% | ⚠️ | [Voir](./q7_rapport.md) |
